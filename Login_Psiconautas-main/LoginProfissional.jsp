...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="LoginProfissional.css">
    ...
    <main>
      <section>
        ...
        <section id="login">      
            ...
            <form action="/teste/checarLoginEspecialista">
            <label class="user">
              <input type="text" placeholder="Usuário ou e-mail" id="user" name="usuarioespecialista"/>
            </label>
            ...
            <label class="button">
              <a href="../prontuario/prontuario.html">
        ...
        <div class="palavra">
         ...
         <section id="create-acc">
          <div id="fechar" onclick="fecha()">X</div>
            ...
            <label class="email">
              <input type="text" placeholder="E-mail" name="usuario" name="email"/>
            </label>
            <label class="senha">
              <input type="password" placeholder="Senha" name="senha" name="senha"/>
            </label>
            <label class="cpf">
              <input type="text" placeholder="CPF" maxlength="11" minlength="11"/>
            </label>
            <label class="next1">
              <input class="innext1" type="button" value="Próximo" onclick="next1()"/>
            </label>
 <!-- Form definido para teste --><!--  -->
            <div class="passos">
        ...
        <section id="dados_pessoais">
          ...
          <label class="cidade">
           ...
           <label class="cidade">
             <input type="text" placeholder="Especialização" name="especializacao"/>
          </label>
            ...
            <label class="next2">
              <input class="innext2" type="submit" value="Concluído"/>
            </label>
            </form>
        ...
        <section id="documentos_psicologo">
          <div id="fechar" onclick="fecha()">X</div>
          <h2 class="ddc">Documentos de comprovação</h2>
          ...
          <div class="documento2">
            <div class="h3-2"><h3 class="estiloh3js-2">2. Documento de inscrição no CRP:</h3></div>
            <div class="branca2">
              <br><br>
              <div class="box">
                <input type="file" name="file-2[]" id="file-2" class="teste teste-2" data-multiple-caption="{count} files selected" multiple />
          ...
          <label class="done">
            <input class="indone" type="submit" value="Concluído"/>
          </label>
